...
export const launchingPricing: PricingPolicy = (
    ...
    ) => Dinero.Dinero = (pricePerMinute, pricePerAdditionalKilometer, includedDistance) => {
    ...
    return flatFeePricing(pricePerMinute, pricePerAdditionalKilometer, includedDistance);
};
